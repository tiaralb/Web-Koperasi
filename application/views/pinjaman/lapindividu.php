<div class="container">
<?php echo form_open('pinjaman/lapindividu','class="col-md-5 hidden-print" style="margin-left:29%;"') ?>
    <div class="panel panel-default">
      	<div class="panel-heading"><b>FORM TRANSAKSI</b></div>
     	<?php if($this->input->post('searching') && count($pinjaman)==0) echo '<label class="alert alert-danger text-center col-sm-12">Data Tidak Ada!</label>';?>
...
<?php if($this->input->post('searching') && count($pinjaman) !=0){ ?>
<div class="" style="width:400px;margin: 0 auto">
	<table  class="table table-border" align="center">
		...
		foreach ($pinjaman as $s) {
		 	echo "<tr>";
		 		echo "<td>Kategori Pinjaman (".$s['id_kategori_pinjaman'].")</td>";
		 		echo "<td>".$s['besar_pinjaman']."(".$s['ket'].")</td>";
		 	echo "</tr>";
		 	$total = $total + $s['besar_pinjaman'];
		} ?>
