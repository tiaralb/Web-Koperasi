<div class="container">
<?php echo form_open('angsuran/lapangsuran','class="col-md-5 hidden-print" style="margin-left:29%;"') ?>
    <div class="panel panel-default">
        <div class="panel-heading"><b>FORM TRANSAKSI</b></div>
      <?php if($this->input->post('searching') && count($angsuran)==0) echo '<label class="alert alert-danger text-center col-sm-12">Data Tidak Ada!</label>';?>
...
<?php if($this->input->post('searching') && count($angsuran) !=0){ ?>
<div class="" style="width:400px;margin: 0 auto">
  <table  class="table table-border" align="center">
    ...
    foreach ($angsuran as $as) {
      echo "<tr>";
        echo "<td>Total Angsuran</td>";
        echo "<td>".$as['besar_angsuran']."</td>";
      echo "</tr>";
