...
<?php echo form_open('angsuran/input','class="form-horizontal col-md-5" style="margin-left:32%;"') ?>
    ...
    <div class="panel-body">
          ...
          <input type="hidden" name="id_pinjaman" value="<?php echo $pinjam[0]['id_pinjaman'] ?>">   
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
           <input type="text" class="form-control" name="angsuran_ke" value="<?php echo $angsuran[0]['angsuran_ke'] ?>" readonly>
          </div>
        </div>
